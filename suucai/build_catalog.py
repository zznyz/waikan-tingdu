...
POSTED = {
    ...
    #     ⚠️ 她确认的是**小红书**；**视频号那版未确认** —— 这张表单一布尔值不分平台，
    #       所以视频号补发 No.12 不算重复（跟读视频与视频号版文案都是现成的：
    #       day12-shackleton/video-assets/ + wenan-*-chuzhong.md 第二条）。同 No.10 那条。
    #   ⇒ 初中外刊已发 = No.1–12；下一个该发 No.13。
    "初中外刊|1","初中外刊|2","初中外刊|3","初中外刊|4","初中外刊|5","初中外刊|6","初中外刊|7","初中外刊|8","初中外刊|9","初中外刊|10","初中外刊|11","初中外刊|12",
}
