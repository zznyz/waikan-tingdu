...
PRODUCTS = [
    ...
    ("听力", "高考精编听力", "高考精编听力.pdf", "62 页", "09-03 08:20",
     "unknown", "ok", "翻到 <b>第 1 页</b>封面：写「<b>高考精编听力</b>」且「160 道往年真题 · 20 道模拟题 · 共 180 道」＝新版；写「高考听力 · 真题精练」或「6 套真题 120 道题」＝旧版。<br>⛔ 对外截图一律用 <code>高考精编听力-无码样张.pdf</code>，别从这份发货版截（第 3/6/9/12/15/18/21/24/27 页有活码）"),
]
